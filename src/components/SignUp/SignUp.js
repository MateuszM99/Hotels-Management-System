                        ...
                        <div className="signup__container__box">
                            ...
                            <div className="signup__container__box__input">
                                ...
                                {errors.firstName && touched.firstName ?
                                    <div className="signup__container__box__validation">{errors.firstName}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                                <label>Last name</label>
                                <Field type="text" placeholder="Enter your last name" name="lastName"></Field>
                                {errors.lastName && touched.lastName ?
                                    <div className="signup__container__box__validation">{errors.lastName}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                                <label>E-mail</label>
                                <Field type="text" placeholder="Enter your email" name="email"></Field>
                                {errors.email && touched.email ?
                                    <div className="signup__container__box__validation">{errors.email}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                                <label>Phone Number</label>
                                <Field type="text" placeholder="Enter your phone number" name="phoneNumber"></Field>
                                {errors.phoneNumber && touched.phoneNumber ? <div
                                    className="signup__container__box__validation">{errors.phoneNumber}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                                <label>Password</label>
                                <Field type="password" placeholder="Enter your password" name="password"></Field>
                                {errors.password && touched.password ?
                                    <div className="signup__container__box__validation">{errors.password}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                            ...
                            <div className="signup__container__box__input">
                                ...
                                {errors.address && touched.address ?
                                    <div className="signup__container__box__validation">{errors.address}</div> : null}
                            </div>
                            <div className="signup__container__box__input">
                            ...
                            <button className="signup__container__box__button"
                                    type="submit">{isSubmitting ? 'Signin up ...' : 'Sign up'}</button>
                            {status && status.errorMessage ? (
                                <div className="signup__container__box__validation">{status.errorMessage}</div>
                            ) : null}
                            <Link className="signup__container__box__signIn" to="/signIn">Already have an account? Sign
                                in</Link>
                        </div>
                    </Form>
                )}
